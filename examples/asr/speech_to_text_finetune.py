...
python examples/asr/speech_to_text_finetune.py \
    +init_from_pretrained_model=stt_en_conformer_ctc_small \
    model.train_ds.manifest_filepath=/home/sruthijgd/Appaji/NeMo/jgd/data/jgd.json \
    model.validation_ds.manifest_filepath=/home/sruthijgd/Appaji/NeMo/jgd/data/jgd.json \
    model.tokenizer.update_tokenizer=True \
    model.tokenizer.dir=/home/sruthijgd/Appaji/NeMo/jgd/tokenizer_spe_unigram_v1024
```
...
def check_vocabulary(asr_model, cfg):
    ...
    if hasattr(cfg.model.tokenizer, 'update_tokenizer') and cfg.model.tokenizer.update_tokenizer:
        ...
        asr_model.cfg.labels=cfg.model.char_labels.labels
        logging.warning("UPDATING VOCAB: The vocabulary of the model has been updated with provided char labels.")
    else:
